...
@section('content')
    <div class="container pt-5">
        <div class="d-flex flex-column text-left mb-5 pt-5">
            <h1 class="display-4 m-0"><span class="text-primary">{{ $section['title'] }}</span></h1>
    ...
    @if (count($section['childSections']) > 0)
        <div class="container pt-5">
            <div class="d-flex flex-column text-center mb-5 pt-5">
                {{-- <h1 class="display-4 m-0"><span class="text-primary">Re</span></h1> --}}
                <h4 class="text-secondary mb-3">Read More</h4>
            </div>
            <div class="row pb-3">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card border-0 mb-2">
                            ...
                            <div class="card-body bg-light p-4">
                                ...
                                <a class="font-weight-bold" href="{{ route('sectionDetail', $childSection['slug']) }}">Read
                                    More</a>
                            </div>
                        </div>
                    </div>
