                        ...
                        @foreach ($sliders as $key => $slider)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-info btn-rounded btn-icon" data-bs-toggle="modal"
                                        data-bs-target="#slider{{ $slider->id }}">
                            ...
                            <div class="modal fade" id="slider{{ $slider->id }}" tabindex="-1"
                                            ...
                                            <form class="forms-sample" method="POST" enctype="multipart/form-data"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="exampleInputUsername1">Title</label>
                                                            <input value="{{ $slider->title }}" name="title"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="exampleInputUsername1">Sub Title</label>
                                                            <input value="{{ $slider->sub_title }}" name="sub_title"
                                                                type="text" class="form-control"
                                                                id="exampleInputUsername1" placeholder="Sub Title">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="file" type="file"
                                                                onchange="fileValidation(false,4,150)"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="status">
                                                                <option value="1"
                                                                    {{ $slider->status == '1' ? 'selected' : '' }}">Active
                                                                </option>
                                                                <option value="0"
                                                                    {{ $slider->status == '0' ? 'selected' : '' }}>In
                                                                    Active
                                                                </option>
                                                            </select>
                                                        </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="modal-footer">
                                                <a href="{{ route('dashboard.sliders.destroy', $slider->id) }}"
