...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="row">
            <form class="forms-sample" method="POST" enctype="multipart/form-data" action="{{ route('dashboard.pages.store') }}">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="exampleInputUsername1">Title</label>
                            <input name="title" type="text" class="form-control @error('title') is-invalid @enderror" id="exampleInputUsername1" placeholder="Title">
                            @error('title')
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input name="slug" type="text" class="form-control" id="exampleInputUsername1" placeholder="Slug">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="row">
